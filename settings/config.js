module.exports = {
  ...
  embed: {
    color: process.env.color || "#06fced",
    wrongcolor: process.env.wrongcolor || "#06fced",
    footertext: "Coded By Darpan",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  // others
  mongodb: process.env.MONGO_URL || "mongodb+srv://darpandasani56:Ui8g7C9gAmy6bxKd@melodydb.6vcpcox.mongodb.net/darpandasani56",
  filters: {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1111563943912161332&permissions=0&scope=bot`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/NGaUeM2QhT`,
    VoteURL: process.env.VoteURL || `https://discord.gg/NGaUeM2QhT`,
    Website: `https://discord.gg/NGaUeM2QhT`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "972801934971007016", // for slash command
  },
};
